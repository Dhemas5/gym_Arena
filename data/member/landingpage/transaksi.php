...
<head>
    ...
    <style>
        ...
        .status-large.approved, .status-large.paid {
            background: rgba(76, 175, 80, 0.2);
            color: #4caf50;
            border: 1px solid #4caf50;
        }
        
        .status-large.rejected, .status-large.expired {
            background: rgba(244, 67, 54, 0.2);
            color: #f44336;
            border: 1px solid #f44336;
        }
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">
                                <span class="badge <?php 
                                    echo ($transaction_detail['status'] === 'approved' || $transaction_detail['status'] === 'paid') ? 'bg-success' : 
                                         (($transaction_detail['status'] === 'rejected' || $transaction_detail['status'] === 'expired') ? 'bg-danger' : 'bg-warning text-dark'); 
                                ?>">
