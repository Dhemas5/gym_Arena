...
<head>
  ...
  <link rel="stylesheet" href="../../../assets/assets_admin/dist/css/custom-regis.css" /> <!-- styling sama seperti login -->
  ...
  <div class="register-box register-container">
    <div class="card card-outline card-primary login-card">
      ...
      <div class="card-body">
        ...
        <p class="mb-1 mt-3"><a href="login.php" class="text-primary">Kembali ke Login</a></p>
